...
namespace deneme12.Migrations
{
    ...
    [Migration("20220317135204_Saatekle3")]
    partial class Saatekle3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("deneme12.Entity.DersProgrami", b =>
                {
                    ...
                    b.Property<int>("DersProgramiListId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("deneme12.Entity.DersProgramiList", b =>
                {
                    b.Property<int>("DersProgramiListId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("DersProgramiListName")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("DersProgramiListId");

                    b.ToTable("DersProgramiList");
                });
            ...
            modelBuilder.Entity("deneme12.Entity.Saat", b =>
                {
                    b.Property<int>("SaatId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("deneme12.Entity.DersProgrami", b =>
                {
                    ...
                    b.HasOne("deneme12.Entity.DersProgramiList", "DersProgramiList")
                        .WithMany("DersProgrami")
                        .HasForeignKey("DersProgramiListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("deneme12.Entity.Saat", "Saat")
                        .WithMany()
